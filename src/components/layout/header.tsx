        ...
        <header className="sticky top-0 z-[9999] w-full border-b border-black bg-white">
            <div className="flex h-20 items-center justify-between pl-4 md:pl-8">
                <div className="flex items-center gap-6 lg:gap-12">
                    <Link href="/" className="flex items-center h-[40px] sm:h-[48px] md:h-[76px] shrink-0 mr-4 md:mr-8 lg:mr-12">
                ...
                <Button asChild className="px-6 py-2 shadow-none hover:translate-x-0 hover:translate-y-0 hover:shadow-none active:translate-x-0 active:translate-y-0 border-l border-b-0 border-t-0 border-r-0 h-full !border-l-black">
                    <Link href="#checkout" className="flex items-center justify-center font-bold">
                        BUY NOW
                    </Link>
                </Button>
            </div>
